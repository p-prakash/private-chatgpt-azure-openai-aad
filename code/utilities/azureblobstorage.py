'''Helper function to handle Azure Blob Storage operations'''
...
class AzureBlobStorageClient:
    'Helper class to handle Azure Blob Storage operations'
    def __init__(self, account_name: str = None,
        ...
        self.connect_str : str = 'DefaultEndpointsProtocol=https;' + \
        ...
        if container_name:
            ...
            self.container_name : str = os.getenv('BLOB_CONTAINER_NAME')
    ...
    def upload_file(self, bytes_data, file_name, content_type='application/pdf'):
        ...
        return blob_client.url + '?' + \
            generate_blob_sas(self.account_name,
                              self.container_name,
                              file_name,account_key=self.account_key,
                              permission="r",
    ...
    def get_all_files(self):
        ...
        #                         container_name,
        #                         blob.name,account_key=account_key,
        #                         permission="r",
        #                         expiry=datetime.utcnow() + timedelta(hours=3))
    ...
    def upsert_blob_metadata(self, file_name, metadata):
        ...
        blob_client = BlobServiceClient.from_connection_string(
                        self.connect_str).get_blob_client(
    ...
    def get_container_sas(self):
        ...
        return "?" + \
              generate_container_sas(account_name=self.account_name,
